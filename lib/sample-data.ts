...
export const sampleKPIs = [
  {
    ...
    change: "+12 bps vs Q2",
    trend: "up" as const,
    description: "Improved asset yields and funding mix optimization",
  },
  {
    title: "Cost-to-Income Ratio",
    value: "52.3%",
    change: "-180 bps vs Q2",
    trend: "up" as const,
  ...
  },
  {
    ...
    change: "-20 bps vs Q2",
    trend: "up" as const,
    description: "Credit quality remains strong",
  },
  {
    title: "ROE",
    value: "14.2%",
...
export const sampleVarianceData = [
  {
    ...
    variance: 7.4,
    variancePercent: 3.1,
    explanation: "Higher loan yields and improved funding mix",
  },
  {
    metric: "Fee Income",
    actual: 89.3,
    ...
    variance: -2.8,
    variancePercent: -3.0,
    explanation: "Lower transaction volumes in Q3",
  },
  {
    ...
    variance: -5.6,
    variancePercent: -3.4,
    explanation: "Cost optimization initiatives and lower marketing spend",
  },
]
...
export const sampleScenarios = [
  {
    id: "1",
    name: "Base Case",
    description: "Current trajectory with existing market conditions",
    assumptions: {
      loanGrowth: 8.5,
      nimExpansion: 15,
      costGrowth: 4.2,
  ...
  },
  {
    id: "3",
    name: "Stress Case",
    description: "Economic downturn with credit deterioration",
    assumptions: {
      loanGrowth: 3.2,
      nimExpansion: 5,
      costGrowth: 5.5,
